...
export const isValid = <T> (value: T, ignored = false): { valid: true, errors: string[], value: T, ignored: boolean } => ({ valid: true, errors: [], value, ignored })

export const isInvalid = <T> (errors: string[], value: T): { valid: false, errors: string[], value: unknown, ignored: boolean } => ({ valid: false, errors, value, ignored: false })
