...
type ExtractArgs<T extends ReadonlyArray<Func<any>>> = { [K in keyof T]: T[K] extends Func<infer V> ? V : never }

export const isTuple = <T extends ReadonlyArray<Func<any>>>(comparer: GetMap<T>, error?: string) =>
